...
import {
  ...
  deleteProject,
  updateProject,
} from "@/app/api/controllers/projectController";
          ...
          <GridCol span={8}>
            <Stack>
              <div>
                ...
                <Input
                  name="title"
                  placeholder="Your project title, please"
              ...
              <div>
                ...
                <Input
                  name="projectUrl"
                  placeholder="The URL for your project"
                  defaultValue={selectedProject?.projectUrl}
                  required
                />
              </div>
              <div>
                ...
                <Input
                  name="externalLink"
                  placeholder="A link to more info about the project"
                  defaultValue={selectedProject?.externalLink ?? undefined}
                />
              </div>
              <Group grow style={{ verticalAlign: "top" }}>
                ...
                <div>
                  ...
                  <Textarea
                    name="descriptionFr"
                    resize="vertical"
                    placeholder="A short description... (In French)"
                    defaultValue={selectedProject?.descriptionFr}
                  />
                </div>
              </Group>
              <Group grow style={{ verticalAlign: "top" }}>
                <div>
                  <Text>Page Description EN</Text>
                  <Textarea
                    name="pageDescriptionEn"
                    resize="vertical"
                    placeholder="Tell me about your project... (In English)"
                    defaultValue={selectedProject?.pageDescriptionEn}
                  />
                </div>
                <div>
                  <Text>Page Description FR</Text>
                  <Textarea
                    name="pageDescriptionFr"
                    resize="vertical"
                    placeholder="Tell me about your project... (In French)"
                    defaultValue={selectedProject?.pageDescriptionFr}
                  />
                </div>
              </Group>
              <Group grow>
                ...
                <div>
                  ...
                  <DateInput
                    ...
                    defaultValue={selectedProject?.endDate ?? undefined}
                  />
                </div>
              </Group>
              <Switch
